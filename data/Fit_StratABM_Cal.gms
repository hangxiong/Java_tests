...
set gn "municipalities in model" /
  ...
  Bocholt, Schleiden, Ratingen, Meerbusch, Hellenthal, "Uebach-Palenberg",
  Bestwig, Lengerich, Radevormwald,
  Siegen, Soest, Issum, Waltrop, "Castrop-Rauxel", Nettetal, "Bad Salzuflen", Rahden,
  Steinfurt, Lemgo, Hoerstel, Nieheim, Steinheim,
  Ruethen, "Bad Wuennenberg", Vettweiss, Luenen, Bochum, Delbrueck,
  ...
  Troisdorf, "Langenfeld (Rhld.)", Extertal, Metelen, Wipperfuerth,
  Schoeppingen, Uedem, "Froendenberg/Ruhr", Coesfeld, Kalkar, Sassenberg,
  Viersen, Buende, Oelde, "Schieder-Schwalenberg", Spenge, Wesel, "Wickede (Ruhr)",
  Steinhagen, Bielefeld, Olpe, Werdohl, Kamen, Emsdetten, Brakel,
  Roedinghausen, Xanten, Haan, "Halle (Westf.)", Gladbeck, Heimbach,
  Beelen, Medebach, "Nachrodt-Wiblingwerde", "Horn-Bad Meinberg",
  Warstein, Luegde, Luedenscheid, Schwalmtal,
  Gummersbach, Ahlen, Senden, Werne, Iserlohn, Titz, Enger, Herford,
  Recke, Finnentrop, Waldfeucht, "Rheda-Wiedenbrueck", Brueggen, Erkelenz,
  Weeze, Wilnsdorf, Datteln, Borken, Bergkamen, Oberhausen, Wettringen,
  Attendorn, Herdecke, Bergheim, Much, Eitorf, Neuss, "Menden (Sauerland)", Wuelfrath,
  Lippstadt, Lichtenau, Hallenberg, Gevelsberg,
  Havixbeck, Petershagen, "Werther (Westf.)", Kleve, Verl,
  "Herzebrock-Clarholz", Ibbenbueren, Erkrath, Lennestadt,
  "Oer-Erkenschwick", Huenxe, Lienen, Noervenich, Erndtebrueck,
  Marsberg, Everswinkel, Euskirchen, "Bad Lippspringe", Huertgenwald,
  Plettenberg, Kalletal, "Gronau (Westf.)", Herten, Doerentrup, Welver,
  Nideggen, Geilenkirchen, Raesfeld, Versmold, Pulheim, Laer, Breckerfeld,
  Westerkappeln, Velbert, "Sundern (Sauerland)", Linnich, Detmold,
  Rosendahl, Espelkamp, "Bedburg-Hau", Paderborn, Beverungen, "Sankt Augustin",
  Niederzier, Elsdorf, Isselburg, "Emmerich am Rhein",
  Wachtberg, "Bad Muenstereifel", Heiden, Wiehl,
  ...
  Stadtlohn, Bueren, Duelmen, Rheinberg, Morsbach, "Bad Sassendorf",
  Geldern, Lage, Burbach, Guetersloh, Schwelm, Frechen, Unna,
  "Preussisch Oldendorf", Anroechte, "Bad Oeynhausen", Saerbeck, Blankenheim,
  Korschenbroich, Kreuzau, Bergneustadt, Kirchhundem, Halver, Arnsberg,
  "Voerde (Niederrhein)", Langenberg, Alpen, Warburg, Niederkruechten,
  Langerwehe, Recklinghausen, "Schloss Holte-Stukenbrock", Kreuztal,
  Ennepetal, Erwitte, Selfkant, "Bad Berleburg", Schermbeck, Luebbecke,
  Sprockhoevel, Meinerzhagen, Hattingen, Olsberg, Kall, Blomberg,
  "Bad Laasphe", "Neunkirchen-Seelscheid", Schalksmuehle, Dortmund,
  Neunkirchen, Boenen, Rietberg, "Kamp-Lintfort", Kranenburg, Willich,
  Drensteinfurt, Minden, Moehnesee, Hemer, "Bad Honnef", Reichshof,
  Juelich, Borchen, Hiddenhausen, Nuembrecht, "Monheim am Rhein",
  "Neukirchen-Vluyn", Rheinbach, "Hennef (Sieg)", Swisttal, Lohmar,
  Weilerswist, Borgentreich, "Porta Westfalica", Merzenich, Brilon,
  Kaarst, Marl, Dorsten, Oerlinghausen, Grefrath, Nettersheim, Rhede,
  Altena, "Wetter (Ruhr)", "Bad Driburg", Ruppichteroth, Siegburg, Hagen,
...
p_cropPrice    "Price of silage maize Euro/dt" /4.3784/
...
*
p_attyield(gn) =  p_yieldMdm(gn,'t2008')/p_drymatter * 10 * (1 + p_affYieldShare);
...
/ [100 * ( exp(p_CRate * p_TDistribution(gn,'t2008',s_process) )
...
*
  ...
  p_gm(gn,spre,spost) = p_revenue(gn,spre,spost) - p_costsVar(gn,spre,spost) - p_HerbRelCosts (spre,'machcostsFix') - p_HerbRelCosts (spost,'machcostsFix') - p_costsInterest(gn,spre,spost);
